...
<div id='flash'>
  ...
  <table>
    <tr>
    	...
    	<th>Buy it</th></tr>
    <tr>
    	<td><img src="bok/javascript-the-definitive-guide.jpg?w=200&amp;h=100&amp;crop-to-fit"></td>
    	<td>JavaScript The Definitive Guide</td>
    	<td>€17</td>
    	<td><button id='book1' class="purchase">Buy it</button></td>
    </tr>
  	<tr>
  		<td><img src="bok/javascript-the-good-parts.jpg?w=200&amp;h=100&amp;crop-to-fit"></td>
  		<td>JavaScript The Good Parts</td>
  		<td>€19</td>
  		<td><button id='book2' class="purchase">Buy it</button></td>
  	</tr>
  	<tr>
	  	<td><img src="bok/jquery-novice-to-ninja.jpg?w=200&amp;h=100&amp;crop-to-fit"></td>
